<!-- converted from phase_1_baseline_version_Runyankore_Edited (1).xlsx -->
...
| note | introduction | Osibire/Oraire ota Ssebo/Nyabo. Nibanyeta ............  Eizina ryangye ni......... ndi omucondoozi orikukorera hamwe n'abahabuzi abarikushwijuma enteekateeka y'okushwijuma emirimo y'obukiiko bw'ebyaro erikukorwa ekitongore kya Communication Development Foundation Uganda (CDFU). Ninyenda kukubuuza ebibuuzo bikye ebirikukwata aha murimo gwawe nk'omwebembezi w'obukiiko bw'ebyaro hamwe n'obukiiko bw'ebyaro obwa (Gamba eiziina ry'ekyaro). Eiziina ryawe rikatooranwa kuruga omu byaro byona kuruga omu (Eiziina ry'orurembo). Ekirikumanyisa ngu buri mwebembezi w'obukiiko bw'ebyaro omu disiturikiti egi akaba aine omugisha ogurikwingana gw'okutooranwa kwejumba omu kubuuzibwa oku. Okwejumba[mu kubuuzibwa oku n'eky'obugabe bwawe. Eby'okugarukamu byawe nibiija kutwarwa nk'ekihama ky'amaani; ekirikumanyisa ngu eiziina ryawe nainga eby'okugarukamu byawe tibirikwija kureebeka nk'ebirikukukwataho. Kandi, tihariho eby'okugarukamu ebihikire nari ebitahikire, byona birikukwata aha kiteekateeko kyawe eky'amazima. Tihariho mugasho gw'okwejumba omu kucondooza oku, kureka amakuru agu orikutuha nigaija kukoresibwa kuhwera omu nteekateeka ez'omumaisho ezirikugyenderera okwongyera amaani omu mirimo y'obukiiko bw'ebyaro. Okubuuzibwa oku nikwija kutwara eshaaha nka emwe. Mbwenu shi, nimbaasa kugumizamu nkakubuuza ebibuuzo? Webare. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| select_one yesno | consent | Niki rungi kugyenda omu maisho n'okubuuzibwa oku? |  |  | quick |  |  |  |  | yes | Consent response is required. |  |  |  |  |  |  |  |  |  |  |  |  |  |
| select_one Attend_CDFU_Training | Attend_CDFU_Training | Orabeireho omu kutendekwa kwona okwakozirwe ekitongore kya Communication for Development Foundation Uganda (CDFU) nainga Foundation for Human Rights Initiative (FHRI)? |  |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| select_multiple Topics_Trained | Topics_Trained | Okutendekwa okwahwire kukaba nikukwata ahari nshonga ki? Select all that apply. |  |  |  |  |  | selected(${Attend_CDFU_Training}, '1') |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| text | Other_Training | Other Specify other training areas |  |  |  |  |  | ${Topics_Trained} = 98 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| integer | Rating_CDFU_Training | Aha rurengo rwa 1-5, 1 eri kubarirwa ahansi kandi 5 eri ahaiguru, no renga ota omushoomo ogu twagambaho aheiguru omu kukuha amagezi go omu kukora aha ntongane omu kyaro kyawe? |  |  |  |  |  | selected(${Attend_CDFU_Training}, '1') |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| begin group | Background | Please observe the following and record your observations |  |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| select_one yesno | M0_Q20 | Observe: Are any LCC records, case books, registers, or proceedings books physically present or available for consultation during this interview? |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| end group |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| end group | end_intro |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| begin group | m0_group | Module 0. Interview metadata, respondent eligibility, and interview context |  |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| note | M0_Q00 | Nitwija kutandika turikukwata amakuru g'okubanza agarikukwata aha kubuuzibwa oku, ekyaro/akakiiko k'ebyaro, hamwe n'omuntu orikubuuzibwa. Amakuru aga nigetengwa kubaasa kuhikaanisa kurungi okubuuzibwa oku n'ebihandiiko by'okucondooza. | Read only if needed. This section is mostly administrative. |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  | Project measurement architecture; Inception Report data linkage strategy |  |  |  |  |  |
...
| text | M0_Q05 | Sub-county / division | Preload from sample frame where possible. |  |  |  |  | ${consent} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | Sampling frame / randomization file |  |  |  |  |  |
| text | M0_Q06 | Parish / ward | Preload from sample frame where possible. |  |  |  |  | ${consent} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | Sampling frame / randomization file |  |  |  |  |  |
| text | M0_Q07 | Village / LCC catchment name | Preload from sample frame where possible. Confirm verbally with respondent. |  |  |  |  | ${consent} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | Sampling frame / randomization file |  |  |  |  |  |
| text | Chairperson_Name | Chairperson's Name |  |  |  |  |  |  |  | yes |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| integer | Tel_Number | Chairperson Telephone Number |  |  |  |  |  |  |  | yes |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| end group | end_m0_group |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| begin group | m1_group | Module 1. Respondent profile and LC role |  |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| note | M1_Q00 | Hati nituza kubuuza ebibuuzo bikye ebirikukwata aha murimo gwawe omu omu kooti y'Ekyaro hamwe n'obumanyi bwawe omu kukora aha nshonga z'omu kakiiko k'ebyaro. | Read aloud as transition. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Project measurement architecture; theory of change |  |  |  |  |  |
| integer | M1_Q04 | omazire emyaka engahi omu nteebe ya lc1 | If less than one year, record 0. |  |  | . >= 0 and . <= 60 | Value must be between 0 and 60. |  |  |  |  |  |  |  |  |  |  |  | Standard respondent profile; heterogeneity analysis |  |  |  |  |  |
| select_one m1_q06 | M1_Q06 | Ori wa buhangwa ki? | Ask respectfully and record respondent’s answer. Do not infer if respondent answers directly. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Gender-disaggregated analysis; safeguards framework |  |  |  |  |  |
| select_one m1_q07 | M1_Q07 | Oine emyaka engahi? | Use age group rather than exact age to reduce sensitivity. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Standard respondent profile |  |  |  |  |  |
| select_one m1_q08 | M1_Q08 | Oine obwegyese ki  obuwakomire ho? | Ask for completed level, not currently attended level. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Standard respondent profile; capacity heterogeneity |  |  |  |  |  |
| text | Other_Education | Specify other Education levels |  |  |  |  |  | ${M1_Q08} = 98 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| select_one m1_q09 | M1_Q09 | No ye kakaasa ota mu ota (Confident) omu kushoma n'okuhandiika emishango ya kooti ya LC? | This refers specifically to written LCC case records, not general reading only. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record-keeping quality; implementation capacity |  |  |  |  |  |
| select_multiple m1_q10 | M1_Q10 | Ni rurimi ki orwo'kubasa kuhandika ebihandiiko bya LCC. Select all that apply. | This captures practical record-keeping capacity. |  |  | (not(selected(., '95') and count-selected(.) > 1)) | Do not combine 'None' or 'Do not know' with other options. |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; data quality protocol |  |  |  |  |  |
| text | M1_Q10_Other | Specify other other language they record court cases |  |  |  |  |  | ${M1_Q08} = 98 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| select_one m1_q11 | M1_Q11 | Waratungire ho okutendekwa kwona aha by'oburingaaniza, okushuganisa, Okushare emishango kitaaka, ebiragiro, okukora aha mishango, nari okwohereza emishango omu kooti? | “Before this programme” means before CDFU/Legatum-related training or mentoring. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Training exposure; Albezreh et al. (2022); Blattman et al. (2014); CDFU training model |  |  |  |  |  |
| select_one m1_q13 | M1_Q13 | Warakozi ho hamwe n'abakozi b'ebiragiro nka pooriisi, kooti, abarikureeberera emishango, abarikureeberera abaana, nari abandi abarikukora aha by'oburingaaniza ? | This captures prior coordination experience, not personal acquaintance. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Coordination/referral mechanism; Rockowitz et al. (2024); Albezreh et al. (2022) |  |  |  |  |  |
| select_multiple m1_q14 | M1_Q14 | Ni nshonga ki aha ziri ahaifo ezi orakozireho nari ezi orakoziremu nk'omwebembezi w'ekyaro kuruga okwezi kw'okubanza 2025 kuhisya hati? | “Handled” includes receiving, hearing, mediating, deciding, recording, or referring a case. |  |  | (not(selected(., '95') and count-selected(.) > 1)) | Do not combine 'None' or 'Do not know' with other options. |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; case classification/triage mechanism |  |  |  |  |  |
| text | M1_Q14_specify | specify other cases or disputes |  |  |  |  |  | selected(${M1_Q14}, '98') |  | yes |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| text | M1_Q14_Other | Specify other cases handled since January 2025 |  |  |  |  |  | ${M1_Q14} = 98 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| select_one m1_q15 | M1_Q15 | Omu sande eya buriijo, noomara obwire burikwingana ki aha mirimo ya Local Council nainga Local Council Court? | Include case handling, community meetings, record keeping, referral, and related LC duties. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Implementation capacity; mentor feasibility |  |  |  |  |  |
| end group | end_m1_group |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| begin group | m2_group | Module 2. Institutional set-up and court composition |  |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| note | M2_Q00 | Hati ninza kukubuuza oku kooti ya Local Council yaawe etebekanisibwe hamwe n'oku eri kukora omu nsharaho y'emishango. | Read aloud as transition. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | CDFU maturity tool; project theory of change |  |  |  |  |  |
| integer | M2_Q01 | Ni abantu bangahi abari memba ba kooti ya Local Council obwahati abarikukora aha mishango? | Include all current members who are officially part of the LC/LCC structure, even if not always active. |  |  | . >= 1 and . <= 30 | Value must be between 1 and 30. |  |  |  |  |  |  |  |  |  |  |  | CDFU maturity tool; LCC institutional structure |  |  |  |  |  |
| select_one m2_q03 | M2_Q03 | Hariho emyanya etarimu bantu omu kooti ya Local Council nainga akakiiko ka LC? | Vacancies include formally unfilled positions or positions where the person is no longer serving. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; institutional capacity |  |  |  |  |  |
| integer | M2_Q04 | Ni emyanya engahi eriho obwahati etarimu bantu? | Ask for the number of vacant positions related to the LCC/committee. |  |  | . >= 1 and . <= 20 | Value must be between 1 and 20. | and ${M2_Q03} = 1 |  |  |  |  |  |  |  |  |  |  | CDFU maturity tool; institutional capacity |  |  |  |  |  |
| integer | M2_Q05 | Ni abakazi bangahi abari ba memba ba kooti y'ekyaro abarikukora aha mishango | If respondent is unsure, ask for best estimate but do not guess for them. |  |  | . >= 0 and . <= ${M2_Q01} | Value must be between 0 and the referenced value. |  |  |  |  |  |  |  |  |  |  |  | CDFU maturity tool; gender and inclusion safeguards |  |  |  |  |  |
| integer | M2_Q06 | Ni mirundi engahi ei waashutamiire omu kooti y'ekyaro okukora aha mishango omu kyaro kyawe omu myezi 12 ehwaire? | This refers to actual practice, not what should happen by law. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; committee functioning |  |  |  |  |  |
| select_one m2_q07 | M2_Q07 | Kooti y'ekyaro kyaawe neekunda ku shitama emirundi eingahi okukora aha mishango? | If sittings depend on whether cases arise, ask what normally happens when there are cases. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; institutional functioning |  |  |  |  |  |
| select_one m2_q08 | M2_Q08 | Kooti y'ekyaro ku yaba ne kora aha mishango, nekiragiro ngu abantu abarikwetengwa (quoram) babebariho? | If respondent does not know the word quorum, explain as “the minimum number of members required to sit or make decisions.” |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; procedural regularity |  |  |  |  |  |
| select_one m2_q09 | M2_Q09 | Kooti ya LC ya nyu eine omwanya gwayo gwetogwire ogu eri kushariraho emishango? | This may be an LC office, community space, or other regular venue. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; institutional set-up |  |  |  |  |  |
| select_one m2_q12 | M2_Q12 | Kooti ya LC eine ekitabo ekyerikuhandika emishango?? | This will be verified later if records are available. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; data quality protocol |  |  |  |  |  |
| select_one m2_q13 | M2_Q13 | Ebihandiiko bya LC ebirikukwata aha mishango byagire omukitabo obwahati (up to date)? | “Up to date” means recent cases have been entered and are not waiting to be recorded. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record-keeping quality |  |  |  |  |  |
| select_one m2_q14 | M2_Q14 | Kooti ya LC eine eby'okukoresa ebirikwetengwa kuhurira emishango n'okukora ebihandiiko? | Materials may include case books, proceedings books, paper, pens, forms, stamps, or other items used locally. |  | quick |  |  | (${M2_Q12} = 1 or ${M2_Q12} = 2) |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; implementation capacity |  |  |  |  |  |
| select_multiple m2_q15 | M2_Q15 | Ni bintu ki ebirikuburaho nari ebitarikumara? select all that apply. | Select all materials reported as missing or insufficient. |  |  |  |  | (${M2_Q14} = 2 or ${M2_Q14} = 3) |  |  | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; implementation capacity |  |  |  |  |  |
| text | M2_Q15_Specify | Specify other materials missing or insufficient |  |  |  |  |  | ${M2_Q15} = 98 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| select_one m2_q16 | M2_Q16 | Enumerator verification: Did you see a case register, case book, or other written LCC record during the interview? | Enumerator should answer based on observation, not respondent report. |  | quick |  |  | ${M0_Q20} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record audit protocol |  |  |  |  |  |
| select_one m2_q17 | M2_Q17 | Enumerator verification: Based on the records seen, do the most recent entries appear to be up to date? | Do not read aloud. Complete after looking at records. |  | quick |  |  | (${M2_Q16} = 1 or ${M2_Q16} = 2 or ${M7_V01} = 1 or ${M7_V01} = 2 or ${M7_V02} = 1 or ${M7_V02} = 2) |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; data quality protocol |  |  |  |  |  |
| text | M2_Q18 | Enumerator notes on LCC institutional set-up or records | Record any relevant observations: no committee present, records locked away, respondent uncertain, records inconsistent, materials missing, etc. |  |  |  |  | (${M2_Q16} = 1 or ${M2_Q16} = 2) |  |  |  |  |  |  |  |  |  |  | Fieldwork data quality protocol |  |  |  |  |  |
| end group | end_m2_group |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| begin group | m3_group | Module 3. Recent caseload and case mix |  |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| note | M3_Q00 | Hati naaza kukubuuza emiringo na enamba  yemishango eyabahererukire  kureeta  omukooti yekyaro. | Read aloud. Emphasize that estimates are acceptable if records are not available, but records should be used whenever possible. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Project measurement architecture; administrative-data validation logic |  |  |  |  |  |
| integer | M3_Q02 | Omubiro 30 ebihingwire, otungire emishango engahi omu Kooti yaawe? | Include cases received, even if not yet resolved. If none, enter 0. |  |  | . >= 0 and . <= 500 | Value must be between 0 and 500. |  |  |  |  |  |  |  |  |  |  |  | Case-flow validation; project primary-outcome linkage |  |  |  |  |  |
| integer | M3_Q03 | Omu myeezi eshatu ehingwire, Kooti y’Ekyaro etungire emishango engahi? | Include all cases received in the last 3 months, whether resolved, pending, or referred. |  |  | (. >= 0 and . <= 1500) and . >= ${M3_Q02} | Value must be within allowed range and greater than or equal to cases in the last 30 days. |  |  |  |  |  |  |  |  |  |  |  | Case-flow validation; project primary-outcome linkage |  |  |  |  |  |
| select_multiple m3_q04 | M3_Q04 | Ni miringo ki y’emishango eyi Kooti etungire  omu myeezi eshatu ehingwire?select all that apply. | Select all types received. Do not ask for sensitive details. |  |  |  |  | ${M3_Q03} > 0 |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; case classification and triage mechanism |  |  |  |  |  |
| select_one m3_q05 | M3_Q05 | Ni muringo ki gw’omushango ogukirizeyo munonga kuhababirwa omu myeezi eshatu ehingwire? | Select the single most common type. If respondent is unsure, ask for best estimate. |  |  |  |  | ${M3_Q03} > 0 |  | yes | This question is required. |  |  |  |  |  |  |  | Forum-choice theory; CDFU case classification logic |  |  |  |  |  |
| select_one m3_q06 | M3_Q06 | Watekateeka aha mishango eyi otungire omu mwezi eshatu ehingwire, emishango emikye eyi mwakozireho neyingana obuucweeka bungahi ahari igana ? | Ask for approximate share, not exact count. |  |  |  |  | ${M3_Q03} > 0 |  | yes | This question is required. |  |  |  |  |  |  |  | Project theory of change; diversion mechanism |  |  |  |  |  |
| integer | M3_Q08 | Nemishango engahi  etakakozirweho omu Kooti yaawe? | Pending means received but not yet closed, resolved, or referred. |  |  | . >= 0 and . <= 500 | Value must be between 0 and 500. |  |  |  |  |  |  |  |  |  |  |  | LC throughput and local resolution mechanism |  |  |  |  |  |
| integer | M3_Q09 | Aha mishango eyi otungire omu myezi eshatu ehingwire, ni emishango engahi eresirwe abantu  ababurijo nari abataine kakwate n’omushango? | Cases brought directly by a party, family member, neighbor, or community member. |  |  | . >= 0 and . <= ${M3_Q03} | Value must be between 0 and the referenced value. | ${M3_Q03} > 0 |  |  |  |  |  |  |  |  |  |  | Forum-choice theory; Krakowski & Kursani (2024) inspired |  |  |  |  |  |
| select_one m3_q14 | M3_Q14 | Ku orikugyeragyeranisa  obwiire obwenyima y’emyeezi eshatu ehingwire na hati, enamba y’emishango  eresirwe omu Kooti yaawe eyeyongire , ekyendiire , ninga tehindukire ? | Ask about perceived change in inflow, not whether the LCC is better or worse. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Benchmarking and process evaluation; forum-choice theory |  |  |  |  |  |
| select_multiple m3_q15 | M3_Q15 | Notekateeka nikintu ki ekyareetsire enamba y’emishango omu Kooti yaawe kweyongira?Select up to three. | Do not read as blame; ask neutrally. |  |  | count-selected(.) <= 3 | Select up to three options. | (${M3_Q14} = 1) |  |  |  |  |  |  |  |  |  |  | Process evaluation; implementation learning |  |  |  |  |  |
| select_multiple m3_q16 | M3_Q16 | Notekateeka ni kintu ki ekyareetsire enamba y’emishango omu Kooti yaawe yakyendera?Select up to three. | Ask neutrally; do not imply decrease is good or bad. |  |  | count-selected(.) <= 3 | Select up to three options. | (${M3_Q14} = 4 or ${M3_Q14} = 5) |  |  |  |  |  |  |  |  |  |  | Process evaluation; implementation learning |  |  |  |  |  |
| select_one m3_q17 | M3_Q17 | Omuri byona, Noyekakasa ota ngu ebiwangambira ebikukwata aha mishango eyibahabahire, gubihikire? | This is a data-quality confidence item. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Data quality protocol; administrative validation strategy |  |  |  |  |  |
| text | M3_Q18 | Enumerator notes on recent caseload and case mix | Record any important context: estimates based only on memory, records incomplete, respondent unsure, unusual recent event, etc. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Fieldwork data quality protocol |  |  |  |  |  |
| end group | end_m3_group |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| begin group | m4_group | Module 4. Legal mandate, jurisdiction, and classification knowledge |  |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| note | M4_Q00 | Hati naaza kukubuuza ahabiika by’emishango eyi Kooti yaawe erikubasa kukoraho, hamwe n’eyi eshemereire kwohereza ahandi ninga court ezindi ezikugikyiraho, hamwe nokwoshemerire kuhurikiriza emishango.
Ebibuuzo ebindakubuze nebyokurebaraho.
Tibyokubuzabuza kureka nitwenda kubikozesa kwenda kumanya emishango nimugitwaza muta . | Read aloud. Emphasize that examples are hypothetical and do not refer to real people. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Project theory of change; CDFU training content; Blattman et al. (2014); Albezreh et al. (2022) |  |  |  |  |  |
| select_multiple m4_q01 | M4_Q01 | Ni mishango ki eyi kooti ya LC1 eshemerire kukoraho kandi ekagihendera?Select all that apply. | This measures perceived jurisdiction. Final scoring should be legally validated. |  |  | (not(selected(., '98') and count-selected(.) > 1)) | Do not combine 'None' or 'Do not know' with other options. |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training manual; LCC legal mandate; classification/triage mechanism |  |  |  |  |  |
| select_multiple m4_q02 | M4_Q02 | Ni mishango ki eyi oshemereire kwohereza omubanyamateka abandi okukira okungekoreraho omu Kooti y’Ekyaro?Select all that apply. | Do not ask for examples from real cases. |  |  | (not(selected(., '98') and count-selected(.) > 1)) | Do not combine 'None' or 'Do not know' with other options. |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training manual; safeguarding framework; Rockowitz et al. (2024) |  |  |  |  |  |
| select_one m4_q04 | M4_Q04 | Omushango gwaba guri aheeru y’obushoboorozi bwa Kooti y’Ekyaro, niki eki court ya LC eshemerire okukoora? (Read all options) | Measures knowledge of referral obligation. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training manual; referral mechanism |  |  |  |  |  |
| select_multiple m4_q05 | M4_Q05 | Nebiki ebishemerirwe kuhandikwa kooti LC yaba neyakyiira ninga nesharamu emishango? Select all that apply. | Measures knowledge of documentation requirements. |  |  | (not(selected(., '98') and count-selected(.) > 1)) | Do not combine 'None' or 'Do not know' with other options. |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record-keeping quality |  |  |  |  |  |
| select_multiple m4_q06 | M4_Q06 | Nimitendera ki Kooti z'ebyaro zishemereire kubanza kukora ki zitakacwiremu omushango?Select all that apply. | Measures procedural knowledge. |  |  | (not(selected(., '98') and count-selected(.) > 1)) | Do not combine 'None' or 'Do not know' with other options. |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training manual; procedural fairness literature; Tyler (1988, 2017) inspired |  |  |  |  |  |
| select_one m4_q07 | M4_Q07 | Nogira ngu niryari  obu kooti yakukozesa  omuringo ogundi gw’omaririza omushango etagwiherize aha poolisi ninga kooti | Measures understanding of ADR boundaries. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; Menkel-Meadow (2007); Braithwaite (2021) |  |  |  |  |  |
| select_multiple m4_q08 | M4_Q08 | Ni mbeera ki eyi Kooti eza baramuzi, Police, hamwe nezindi Kooti neinga abantun nka abarashuganisa ebya'maaka, na'baana bashemerire kwejumbira omukucwa emishango? Select all that apply. | Measures referral classification. |  |  | (not(selected(., '98') and count-selected(.) > 1)) | Do not combine 'None' or 'Do not know' with other options. |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; safeguarding framework; Rockowitz et al. (2024) |  |  |  |  |  |
| select_one m4_q10 | M4_Q10 | Oye kakaasa ekikwinganaki omu kumanya gye emishango ei kooti y'ebyaro erikubaasa kusharamu hamwe n'emishango ei eshemereire kwoherezibwa omu kooti enkuru? | Self-assessed competence; not a substitute for vignette scoring. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Project theory of change; training evaluation logic |  |  |  |  |  |
| note | M4_V00 | Hati ninza kushoma eby'okureeberaho ebikukwata aha mishango ye Kyaro. Buri ky'okureeberaho, nkweshengyereza ongambire eki kooti ya Local Council eshemereire kukora. Eby'okureeberaho ebi tibirikukwata aha bantu abari omu kyaro eki | Read aloud. Do not coach respondent. Do not reveal whether answers are correct. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Survey vignette methodology; classification/triage mechanism |  |  |  |  |  |
| note | M4_V01_CASE | obutikirizangana yemyataano.Abaturagye babiri bafire obutaikirizana aha myataano ya mataka gaabo. Tibarwaana ,tibatinisirizana, kandi boona  nibenda kushitama hamwe  bakaikirizana .Omwe yaaza omu Kooti y’Ekyaro kushaba obuyambi. | Read exactly as written. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | CDFU case types; community dispute-resolution literature; Blattman et al. (2014) inspired |  |  |  |  |  |
| select_one m4_v01_q1 | M4_V01_Q1 | Omuri ryo'kureberaho ki, Kooti y’Ekyaro neebaasa kukora aha mushango ogu egumare kitaka? | Final correct classification to be validated with CDFU/legal expert. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; LCC jurisdiction |  |  |  |  |  |
| select_one m4_v01_q2 | M4_V01_Q2 | Kooti y’Ekyaro eshemereire kubanza kukora ki omuri eki? | Do not read response options unless needed; classify answer. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; ADR mechanism |  |  |  |  |  |
| select_multiple m4_v01_q3 | M4_V01_Q3 | Ni bobushoborozi ki abandi abashemereire kubanza kwejumbira  ninga kumanyisibwa omu mushango ogu?Select all that apply. | Final scoring to be validated. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; referral mechanism |  |  |  |  |  |
| note | M4_V02_CASE | eky'okureeberaho 2: Obutaikirizana omu maka. Omushaija n'omukazi we beibaija omu kooti y'ekyaro ahabw'okugira ngu nibatongana aha byo'bujunaanizibwa bw'omuka yaabo, hamwe n'esente. Tihaine owahutaza omu mubiri gwondijo, owa nyangaraza ondijo obyo by'okuteerana, nari okutiinatiinisa. Kandi bombi nibagira ngu nibenda obuhwezi omu kumaraho obutaikirizana. | Read exactly as written. Do not add examples. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | CDFU case types; mediation and procedural justice literature |  |  |  |  |  |
| select_one m4_v02_q1 | M4_V02_Q1 | Omuri kyo kureberaho ki, Kooti y’Ekyaro neebaasa kukora aha mushango ogu egumare kitaka? | Final correct classification to be validated. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; LCC jurisdiction |  |  |  |  |  |
| select_one m4_v02_q2 | M4_V02_Q2 | Kooti y’Ekyaro eshemereire kubanza kukora ki omuri eki? | Do not coach. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; ADR mechanism; Tyler (1988, 2017) inspired |  |  |  |  |  |
| select_multiple m4_v02_q3 | M4_V02_Q3 | Ni bobushoborozi ki abandi abashemereire kubanza kwejumbira  ninga kumanyisibwa omu mushango ogu?Select all that apply. | Final scoring to be validated. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; referral mechanism |  |  |  |  |  |
| note | M4_V05_CASE | Eky'okureeberaho 3: Ebikukwata aha kwerinda kw'abaana. Muriranwa yaagira ngu omwana omu kyaro naakira kuteerwa munonga omuka kandi obumwe naareebeka aine obuhuta kandi atiinire. Omwana tiyeija omu kooti ya Local Council, kwonka muriranwa niwe yeija, kushaaba LCC kutaahamu shonga egi. | Read exactly as written. Do not probe for real examples. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Safeguarding framework; Mennen (2010); Rockowitz et al. (2024) inspired |  |  |  |  |  |
| select_one m4_v05_q1 | M4_V05_Q1 | Omuri kyo kureberaho ki, ekyokureberaho Kooti y’Ekyaro neebaasa kukora aha mushango ogu egumare kitaka? | This should generally test recognition of child-protection referral need; final scoring to be validated. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Safeguarding framework; CDFU referral content |  |  |  |  |  |
| select_one m4_v05_q2 | M4_V05_Q2 | Kooti y’Ekyaro eshemereire kubanza kukora ki omuri eki? | Do not coach. Sensitive case safeguard item. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Safeguarding framework |  |  |  |  |  |
| select_multiple m4_v05_q3 | M4_V05_Q3 | Ni bobushoborozi ki abandi abashemereire kubanza kwejumbira  ninga kumanyisibwa omu mushango ogu?Select all that apply. | Final scoring to be validated. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Safeguarding framework; referral pathway |  |  |  |  |  |
| note | M4_V06_CASE | Eky'okureeberaho 4: Okunyangarazibwa omu by'okuteerana. Omukazi naagira ngu akahambwa omushaija omu kyanga. Aine obwoba. Nabuza kooti yekyaaro ngu akore ki? | Read exactly as written. Do not probe. If respondent discloses a real case, follow safeguarding protocol. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Safeguarding framework; Rockowitz et al. (2024); Albezreh et al. (2022) |  |  |  |  |  |
| select_one m4_v06_q1 | M4_V06_Q1 | Omu ky'okureeberaho eki, kooti ya Local Council neebaasa kukora aha mushango ogu omu kyaro kurabira omu okushunganisa aba babiri? | This is a safeguarding-critical classification item. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Safeguarding framework; CDFU referral content |  |  |  |  |  |
| select_one m4_v06_q2 | M4_V06_Q2 | Kooti y’Ekyaro eshemereire kubanza kukora ki omuri eki? | Do not coach. Sensitive case safeguard item. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Safeguarding framework; Rockowitz et al. (2024) |  |  |  |  |  |
| select_multiple m4_v06_q3 | M4_V06_Q3 | Ni bobushoborozi ki abandi abashemereire kubanza kwejumbira  ninga kumanyisibwa omu mushango ogu?Select all that apply. | Final scoring to be validated. Do not ask for real case details. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Safeguarding framework; multisectoral referral literature; Albezreh et al. (2022); Rockowitz et al. (2024) |  |  |  |  |  |
| select_one m4_q11 | M4_Q11 | Okutwariza hamwe, kyaba kikugumira kita kusharamu eki kooti y'ebyaro eshemereire kukora omu by'okureeberaho ebi ebinamaara kukushomera? | This helps interpret vignette performance and perceived ambiguity. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Survey measurement quality; classification/triage mechanism |  |  |  |  |  |
| text | M4_Q12 | Enumerator notes on mandate, jurisdiction, and classification knowledge | Record if respondent seemed confused, asked for clarification, disclosed a real case, or if there were interruptions. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Fieldwork data quality protocol |  |  |  |  |  |
| end group | end_m4_group |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| begin group | m5_group | Module 5. ADR and mediation practice |  |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| note | M5_Q00 | Hati ninza kubuuza oku kooti ya Local Council erikukira kukoresa , okuganiira, okushunganisa ,okugarukanisa, nari emiringo endiijo youkushoborora entongane ezirikubaasa kushoboororwa omu kooti. | Read aloud. Emphasize that this section refers to eligible petty or minor disputes, not serious cases that must be referred. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | CDFU training content; Menkel-Meadow (2007); Braithwaite (2021); Blattman et al. (2014) |  |  |  |  |  |
| select_one m5_q01 | M5_Q01 | omushango omukye kubarikugureeta omukooti yaawe , niryari obu kooti erikubanza kushuganisa , kuganira, kugarukanisa ninga kukozesa emiringo endijo gutaka shakiire? | This refers only to cases that are suitable for local handling. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; ADR mechanism; Blattman et al. (2014) |  |  |  |  |  |
| select_one m5_q02 | M5_Q02 | Omu kugarukanisa, niryaari obu embaju zoona niziheebwa omugisha gw'okushoborora enshonga zaabo? | This is a core procedural fairness item. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Tyler (1988, 2017); Creutzfeldt & Bradford (2016); CDFU training content |  |  |  |  |  |
| select_one m5_q03 | M5_Q03 | Omu kuteisa, niburi ryari obu abantu bakwe gamba ho bataine ekirikubateganisa, barikushoboorora enshonga zaabo? | Ask about normal practice, not one exceptional case. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Procedural justice: voice and respectful treatment; Tyler (1988, 2017) |  |  |  |  |  |
| select_one m5_q06 | M5_Q06 | Obu emitendera yo kuramura kyitaka kwekuhika ahamuheru. Niryari obu ebikweikirizingana ho mukubihandika omundagano? | Agreement may be written in register, proceedings book, or other written record. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record-keeping quality; ADR mechanism |  |  |  |  |  |
| select_one m5_q07 | M5_Q07 | Bwanyima y'okuhika aha ndagaano, niryari obu LCC ekukuratiriza (follow-up) okureeba ngu embaju zahikiriza ebyaragainwe omu endagaano? | Follow-up may be by phone, visit, later meeting, or party report. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | ADR quality; restorative justice practice; CDFU maturity tool inspired |  |  |  |  |  |
| select_one m5_q09 | M5_Q09 | Noyekakasa ota omu kushoborora entongane ezishemerire oba ezirimumateeka kushobororwa omu kooti ey ekyaaro? | Self-efficacy item; not a substitute for observed practice. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Training evaluation logic; Albezreh et al. (2022); CDFU training content |  |  |  |  |  |
| select_one m5_q10 | M5_Q10 | Noyekakasa ota omu kucureeza nari okukyendeeza obutaikirizana ahagati y'abantu entongane zabo zitabeire mbi munonga? | Refers to de-escalation, not legal decision-making. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Conflict management training; restorative-responsive justice theory; Braithwaite (2021) |  |  |  |  |  |
| select_multiple m5_q11 | M5_Q11 | Ni bintu ki ebirikuremesa okugarukanisa abantu kitaaka omu kooti z'ebyaro? Select up to three. . | Ask neutrally. Do not suggest that the LCC is at fault. |  |  | count-selected(.) <= 3 | Select up to three options. |  |  |  |  |  |  |  |  |  |  |  | Process evaluation; ADR implementation barriers; Swenson (2018); Rockowitz et al. (2024) inspired |  |  |  |  |  |
| select_multiple m5_q13 | M5_Q13 | Ni miringo ki ei LCC erikukozesa omu kushoborora obutaikirizana obutari bwa maani?Select all that apply | Select all methods used in practice. |  |  | (not(selected(., '95') and count-selected(.) > 1)) | Do not combine 'None' or 'Do not know' with other options. |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; ADR/restorative justice literature |  |  |  |  |  |
| select_one m5_q14 | M5_Q14 | Kooti yekyaro kwekwihika endagano omumishonga etari mihango munonga, Niryari obu abantu bari omumishango egyo, bakugendera aha ndangano ya Kooti egi. | Ask about typical practice, not one exceptional case. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | ADR outcome quality; restorative justice literature |  |  |  |  |  |
| select_one m5_q15 | M5_Q15 | Omuntu omwe ku arikuremwa kukuratira endagaano, kooti ya LCC nekiira kukora ki? | Measures post-agreement handling. Final legal scoring to be validated. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; ADR follow-up; referral mechanism |  |  |  |  |  |
| select_one m5_q16 | M5_Q16 | Omu kuteekateeka kwawe, kooti ya LCC nikihwera kita okuzibira entongane z'omunda kweyongyera kuhika aha pooriisi nainga omu kooti? | Measures perceived diversion mechanism; not primary outcome. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Project theory of change; diversion mechanism; Blattman et al. (2014) inspired |  |  |  |  |  |
| text | M5_Q17 | Enumerator notes on ADR and mediation practice | Record if respondent gave examples, seemed uncertain, contradicted earlier case-handling answers, or if another person influenced the response. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Fieldwork data quality protocol |  |  |  |  |  |
| end group | end_m5_group |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| begin group | m6_group | Module 6. Referral practice and coordination with formal institutions |  |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| note | M6_Q00 | Hati ninza kukubuuza ebibuuzo ebirikukwata aha mishango ei kooti z'ebyaro zirikuheereza aha poriisi, kooti ezaheiguru, ebitongore ebirikureeberera abaana, n'ebindi bitongore, hamwe n'oku kooti z'ebyaro zirikukwatanisa n'ebitongore ebyo. | Read aloud. Emphasize that referral is not a failure; it may be the appropriate response when a case is outside LCC mandate. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Project theory of change; CDFU training content; Albezreh et al. (2022); Rockowitz et al. (2024) |  |  |  |  |  |
| select_one m6_q01 | M6_Q01 | Omushango gwaba guri muhango aha kooti ya LC nainga guri ogw'amaani munonga, niryari obu LCC ekuha ab'obushoborozi abahikire omushango? | This refers to cases that should not be resolved locally. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; referral appropriateness mechanism |  |  |  |  |  |
| integer | M3_Q10 | Aha mishango eyatungirwe omu myezi eshatu ehwaire, ni engahi eyahairweyo omu kooti z'ebyaro, ab'eby'okwerinda, kooti, ab'ebyaro abandi, abebembezi b'ebyanga, nainga ebitongore ebindi? | This should include formal and informal referrals to the LCC. |  |  | . >= 0 and . <= ${M3_Q03} | Value must be between 0 and the referenced value. | and ${M3_Q03} > 0 |  |  |  |  |  |  |  |  |  |  | Coordination/referral mechanism; Rockowitz et al. (2024); Albezreh et al. (2022) inspired |  |  |  |  |  |
| select_multiple m3_q11 | M3_Q11 | Ni muntu ki owahaireyo emishango omu kitongore eki omu myezi eshatu ehwaire? Toorana ebyo byona ebirikukwataho. | Select all actors that referred at least one case. |  |  |  |  | and ${M3_Q10} > 0 |  | yes | This question is required. |  |  |  |  |  |  |  | Coordination/referral mechanism |  |  |  |  |  |
| integer | M3_Q12 | Aha mishango eyatungirwe omu myezi eshatu ehwaire, ni engahi eyahereize pooriisi, kooti, okurabura, okurinda abaana, nainga ekitongore ekindi? | This is about referrals made by the LCC to another authority. |  |  | . >= 0 and . <= ${M3_Q03} | Value must be between 0 and the referenced value. | and ${M3_Q03} > 0 |  |  |  |  |  |  |  |  |  |  | Referral appropriateness; project theory of change |  |  |  |  |  |
| select_multiple m3_q13 | M3_Q13 | Ekitongore kya LCC kikatwara nkahi emishango omu myezi eshatu ehwaire? Toorana ebyo byona ebirikukwataho. | Select all referral destinations. |  |  |  |  | and ${M3_Q12} > 0 |  | yes | This question is required. |  |  |  |  |  |  |  | Coordination/referral mechanism; safeguarding framework |  |  |  |  |  |
| select_multiple m6_q04 | M6_Q04 | Ni nshonga ki enkuru ezareesire okwohereza emishango egi omubanyamateeka neinga obobushoborozi abandi  omu myezi eshatu ehwaire? Toorana zoona ezirikukora | Select all reasons mentioned. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; referral appropriateness |  |  |  |  |  |
| select_one m6_q05 | M6_Q05 | LC yaawe ku erikuheereza omushango omu kitongore ekindi, niryari obu okwoherezibwa oku kuri kuhandikwa omubitabo rya LC yaawe? | Documentation may be in any formal or informal written LCC record. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record-keeping quality; referral documentation |  |  |  |  |  |
| select_one m6_q08 | M6_Q08 | Bwanyima y'okuhayo emishango owa banyamateeka nainga abobushoborozi abandi aba heiguru, naryari obwo kukira kutunga okugarukwamui? | Receiving authority may be police, court, probation, child protection, or another institution. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Coordination bottlenecks; Rockowitz et al. (2024); Albezreh et al. (2022) |  |  |  |  |  |
| select_one m6_q09 | M6_Q09 | Okutwariza hamwe, kyanguhi nari kigumire ekitongore kya LCC kukwatanisa na pooriisi omushango gwaba nigwetenga pooriisi okugwejumbira mu? | Ask about normal experience, not a single case. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Coordination mechanism; justice-chain interface |  |  |  |  |  |
| select_one m6_q10 | M6_Q10 | Okutwarira hamwe, kyanguhi nari kigumire ekitongore kya LCC kukwatanisa na kooti ezaheiguru omushango gwaba nigwetenga okwejumbiramu kwa kooti ezo? | Ask about normal experience, not a single case. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Coordination mechanism; justice-chain interface |  |  |  |  |  |
| select_multiple m6_q12 | M6_Q12 | Ni bizibuki eiwe owa LCC ebyorikubugana waba noyohereza emishango omu kooti neinga abobushoborozi abaheiguru aha mishango oyo takubasa kukoraho aha kooti ya LC | Ask neutrally. Do not imply blame toward any institution. |  |  | count-selected(.) <= 3 | Select up to three options. |  |  |  |  |  |  |  |  |  |  |  | Coordination barriers; process evaluation; access to justice literature |  |  |  |  |  |
| select_one m6_q14 | M6_Q14 | Noyekakasa ota omukumanya nkahi ohoine kwohereza emishango eya mateeka gatakwikiriza kushagwo aha rurengo rya kooti yaawe? | Self-efficacy item. Compare with vignette classification in Module 4. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Training evaluation logic; CDFU referral content |  |  |  |  |  |
| select_one m6_q15 | M6_Q15 | Nowekaakasa ota omumagezi no'kumanya o kushoboororera abantu ahabwenki emishango emwe eshemereire kutwarwa omu kooti ezindi omu mwanya gw'okugikorera omu kooti kyaro kyaawe? | Captures ability to communicate jurisdictional boundaries and maintain legitimacy. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Procedural fairness/explanation; Tyler (1988, 2017); CDFU training content |  |  |  |  |  |
| select_one m6_q16 | M6_Q16 | Enumerator verification: In the records seen today, is there any written evidence that referred cases are recorded as referrals? | Enumerator should answer based on records, not respondent report. |  | quick |  |  | ${M0_Q20} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record audit protocol |  |  |  |  |  |
| select_one m6_q17 | M6_Q17 | Enumerator verification: In the records seen today, is the destination of referral usually recorded? | Destination means police, court, probation, child protection, etc. |  | quick |  |  | ${M0_Q20} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record audit protocol |  |  |  |  |  |
| text | M6_Q18 | Enumerator notes on referral practice and coordination | Record relevant context: respondent mentions poor police/court coordination, no referral forms, sensitive cases, incomplete records, or contradiction with earlier answers. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Fieldwork data quality protocol |  |  |  |  |  |
| end group | end_m6_group |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| begin group | m7_group | Module 7. Record-keeping and case management quality |  |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| note | M7_Q00 | Hati ninza kubuuza oku kooti y'ekyaro erikubiika ebihandiiko by'emishango, okuhurira emishango, ebirugamu, okuhaburwa, hamwe n'endagaano. Ebihandiiko byaba biriho, nitubaasa kubishaba kubireeba kugira ngu tukyebe oku ebintu byahandiikwa. Titurikwija kubihandiika omu bitabo byaitu. | Read aloud. Emphasize confidentiality. Do not record party names or identifying details. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | CDFU maturity tool; project administrative-data strategy |  |  |  |  |  |
| select_one m7_q01 | M7_Q01 | Kooti ya LC eriho obwahati eine ekitabo ky'okuhandikamu emishango? | This may repeat earlier information but is asked here as the start of detailed record-quality assessment. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record-keeping quality |  |  |  |  |  |
| select_multiple m7_q03 | M7_Q03 | Ni bihandiiko ki ebyahandikirwe ebi LCC erikubiika? Toorana byona ebirikukwataho. | Select all record types currently used. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record audit protocol |  |  |  |  |  |
| select_one m7_q04 | M7_Q04 | Ebihandiiko bya LCC obwahati bihikire? | “Up to date” means recent cases have been entered and are not waiting to be recorded. |  | quick |  |  | (${M7_Q01} = 1 or ${M7_Q01} = 2) |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; data quality protocol |  |  |  |  |  |
| select_one m7_q05 | M7_Q05 | Omushango ogwahererukireyo kutaaha omu bihandiiko bya LCC gukataahamu ryari? | Ask respondent to use the records if available. |  |  |  |  | (${M7_Q01} = 1 or ${M7_Q01} = 2) |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record recency |  |  |  |  |  |
| select_multiple m7_q06 | M7_Q06 | Omushango ku gurikuhandiikwa, ni makuru ki agarikukira kuba garimu? Toorana goona agarikukora. | Ask about usual recording practice. |  |  |  |  | (${M7_Q01} = 1 or ${M7_Q01} = 2) |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; documentation requirements |  |  |  |  |  |
| select_one m7_q08 | M7_Q08 | Ebirugire omu kusharamu, nari okukirizana nibihandiikwa buri ryari? | Outcome may include resolved, pending, referred, withdrawn, or agreement reached. |  |  |  |  | (${M7_Q01} = 1 or ${M7_Q01} = 2) |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; local resolution outcome |  |  |  |  |  |
| select_one m7_q12 | M7_Q12 | Omuntu ku yaakushaba ebikukwata aha mushango gu washazire omu myezi eshatu ehwaire, kyanguhi kita gufuuna kuruga omu bihandiiko byawe? | Ask about records generally, not confidential access by outsiders. |  |  |  |  | (${M7_Q01} = 1 or ${M7_Q01} = 2) |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; data accessibility |  |  |  |  |  |
| select_one m7_q13 | M7_Q13 | Ebihandiiko by'amishango ya Kooti yaawe nibibiikwa omu mwanya ogurinzirwe gye kugira ngu bitabura, bitasiisikara, kandi bitahikwaho abantu abatashemereire? | Secure storage may include locked cabinet, locked room, or another protected location. |  | quick |  |  | (${M7_Q01} = 1 or ${M7_Q01} = 2) |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; confidentiality/data protection |  |  |  |  |  |
| select_multiple m7_q14 | M7_Q14 | N'oha orikubaasa kuhikwaho aha bihandiiko by'omushango gwa LCC? Select all that apply. | This item captures confidentiality and access control. |  |  |  |  | (${M7_Q01} = 1 or ${M7_Q01} = 2) |  | yes | This question is required. |  |  |  |  |  |  |  | Data protection protocol; CDFU maturity tool |  |  |  |  |  |
| select_multiple m7_q15 | M7_Q15 | Ni buremeezi ki oburikukirayo obuhango obu kooti yaawe erikushanga omu kubika ebihandiko bya kooti ebihweire nka bikikire? Select all that apply | Ask neutrally. Do not imply blame. |  |  | count-selected(.) <= 3 | Select up to three options. |  |  |  |  |  |  |  |  |  |  |  | CDFU maturity tool; implementation barriers |  |  |  |  |  |
| note | M7_V00 | Enumerator: You will now complete a brief verification of the LCC records that are physically available. Do not record names, addresses, phone numbers, or details that could identify parties. Only check whether fields are present and complete. | Do not read aloud unless needed. Follow confidentiality protocol. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | CDFU maturity tool; record audit protocol; data protection protocol |  |  |  |  |  |
| select_one m7_v01 | M7_V01 | Enumerator verification: Did you see a case register or case book? | Complete based on observation, not respondent report. |  | quick |  |  | ${M0_Q20} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record audit protocol |  |  |  |  |  |
| select_one m7_v02 | M7_V02 | Enumerator verification: Did you see a proceedings book or hearing/mediation notes? | Complete based on observation. |  | quick |  |  | ${M0_Q20} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record audit protocol |  |  |  |  |  |
| select_one m7_v12 | M7_V12 | Enumerator verification: Where were the records stored at the time of the interview? | Do not request access to private storage beyond what respondent voluntarily shows. |  |  |  |  | ((${M7_V01} = 1 or ${M7_V01} = 2) and (${M7_V02} = 1 or ${M7_V02} = 2)) |  | yes | This question is required. |  |  |  |  |  |  |  | Data protection protocol; CDFU maturity tool |  |  |  |  |  |
| select_one m7_v13 | M7_V13 | Enumerator verification: Overall, how complete and usable did the available LCC records appear for monitoring case flow? | This is an enumerator judgment after reviewing records. |  |  |  |  | ${M0_Q20} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | Administrative-data quality protocol; project measurement strategy |  |  |  |  |  |
| select_one m7_v14 | M7_V14 | Enumerator verification: Why could records not be verified during this interview? | Complete based on respondent explanation and observation. |  |  |  |  | ${M0_Q20} != 1 |  | yes | This question is required. |  |  |  |  |  |  |  | Fieldwork data quality protocol |  |  |  |  |  |
| text | M7_Q16 | Enumerator notes on record-keeping and case management quality | Record any relevant observations: missing books, incomplete records, respondent uncertainty, poor storage, contradiction between self-report and records, or privacy concerns. Do not record names or case details. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Fieldwork data quality protocol |  |  |  |  |  |
| end group | end_m7_group |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| begin group | m8_group | Module 8. Committee sitting and decision-making process |  |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| note | M8_Q00 | Hati ninza kukubuuza oku kooti y'ekyaro erikushutama, ekushara emishango, n'okukora encwamu nk'akakiiko ,garukamu kurugira kokumukukora ebi omu kooti yanyu. | Read aloud as transition. Emphasize actual practice, not only formal rules. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | CDFU maturity tool; project theory of change; procedural regularity |  |  |  |  |  |
| select_one m8_q01 | M8_Q01 | Kooti y'ekyaro kyanyu neshaara eta emishango obutosha? | Ask about the usual practice across cases, not one exceptional case. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; institutional functioning |  |  |  |  |  |
| select_one m8_q03 | M8_Q03 | Omu kuhanuura aha mishango, niryari obu abanyakakiiko abataribamwe na bamwe bakuherezayo ebitekateko byaabo okira oku rekyera okuteisa obantu bamwe? | “Actively participate” includes asking questions, giving views, helping mediate, or contributing to a decision. |  |  |  |  | (${M8_Q01} = 1 or ${M8_Q01} = 2) |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; collective decision-making |  |  |  |  |  |
| select_one m8_q04 | M8_Q04 | Batakatungire encwamu, okwikirizana, nainga okwohereza omushango omu kooti, niryari obu akakiiko kakugamba aha mishango haamwe nka ka kiiko? | This includes discussion before mediation outcome, decision, or referral. |  |  |  |  | (${M8_Q01} = 1 or ${M8_Q01} = 2) |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; procedural regularity |  |  |  |  |  |
| select_one m8_q06 | M8_Q06 | Abakazi ku barikuba bari abanyakakiiko, ryari obu bakweejumbira omu kugaaniira n'okusharamu emishango? | Ask about participation in practice, not formal membership only. |  |  |  |  | ${M2_Q05} > 0 |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; gender and inclusion safeguards |  |  |  |  |  |
| select_one m8_q07 | M8_Q07 | Hariho enkora yona neinga enteekateeka y'okureeba ngu ebitekyerezo ne nshonga zabakazi ba ka kiiko omuku kushara emishango bya tekwa omunkoora? | Ask neutrally. This does not replace women’s formal participation but helps identify local practice. |  | quick |  |  | ${M2_Q05} > 0 |  | yes | This question is required. |  |  |  |  |  |  |  | Gender and inclusion safeguards; procedural fairness |  |  |  |  |  |
| select_one m8_q08 | M8_Q08 | Omushango ku gurikushwarwa, kwogyegwa yo omu kooti ezindi, niryari obu ebihandiiko bikuteerwaho omukono, sitampu, nari nibikahamibwa abanyakakiiko ba LCC abarikurenga ahari omwe? | Validation may include signatures, initials, stamp, or written confirmation by more than one member. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record validation and case-management quality |  |  |  |  |  |
| select_one m8_q09 | M8_Q09 | Aka kiiko ka court ya LC nikashitama okushwijuma emishango etakahweire, etakashazigwe mu, neinga eyayongirwe yo omu kooti ezindi? | This refers to case review meetings, not only hearings with parties. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; case-management quality |  |  |  |  |  |
| select_one m8_q11 | M8_Q11 | Ba memba b'akakiiko ku barikuhakana aha ku bashemereire kukora aha mushango, ekirikukira kubaho n'enki? | Ask about usual practice. Do not ask for examples involving real parties. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Procedural regularity; internal deliberation; Tyler (1988, 2017) inspired |  |  |  |  |  |
| select_one m8_q12 | M8_Q12 | Nenkyuro zingahi ezi ab'akakiiko barikuhakana yaaba omushango gushemereire kushagwa mu kooti egi yekyaaro nainga gusindikwe omu b'obushoborozi abandi? | This captures uncertainty in triage and referral decisions. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Case classification/triage mechanism; CDFU training content |  |  |  |  |  |
| select_one m8_q13 | M8_Q13 | Okusharaho kwa LCC nikuhikaana kuta omu mishango erikushushana? | Similar cases means cases of a similar type and seriousness. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Procedural fairness: consistency/neutrality; Tyler (1988); Jackson (2018) |  |  |  |  |  |
| select_one m8_q14 | M8_Q14 | Noye kakaasa ota ngu kooti ya LC egi nikikuratira engyenderwaho niyo emwe omu kukora aha mishango ekushushwana? | Self-assessed procedural consistency. Compare with record and vignette measures. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; procedural regularity |  |  |  |  |  |
| select_multiple m8_q15 | M8_Q15 | Ni buremeezi ki oburikukirayo obwingi oburi kuremesa akakiiko ka court yekyaro kyaawe okukoora emirimo ya ko? | Ask neutrally. Do not imply fault. |  |  | count-selected(.) <= 3 | Select up to three options. |  |  |  |  |  |  |  |  |  |  |  | CDFU maturity tool; process evaluation |  |  |  |  |  |
| select_one m8_v01 | M8_V01 | Enumerator verification: In the records seen today, is there evidence that more than one LCC member participates in hearings, mediation, decisions, or referrals? | Look for signatures, names, initials, members present, or similar evidence. Do not copy names. |  | quick |  |  | ${M0_Q20} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record audit protocol |  |  |  |  |  |
| select_one m8_v02 | M8_V02 | Enumerator verification: In the records seen today, is there evidence that decisions, agreements, or referrals are signed or validated by more than one member? | Do not record names or signatures; only record whether evidence exists. |  | quick |  |  | ${M0_Q20} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; record validation |  |  |  |  |  |
| text | M8_Q16 | Enumerator notes on committee sitting and decision-making process | Record relevant observations: respondent indicates decisions are mainly individual, committee absent, quorum unclear, women members absent, records contradict self-report, or any interruptions. Do not record case details. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Fieldwork data quality protocol |  |  |  |  |  |
| end group | end_m8_group |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| begin group | m9_group | Module 9. Procedural fairness orientation and perceived local legitimacy |  |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| note | M9_Q00 | Hati ninza kukubuuza ebikwatageine n'oburingaaniza, obwesigye, hamwe n'oku abantu barikutwara kooti z'ebyaro. Ngambira eki orikureeba n'ebi orikumanya ebirikukwata aha mishango erikureetwa omu kooti z'ebyaro | Read aloud as transition. Emphasize that the questions are about general practice and perceptions, not any specific case. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Procedural justice and legitimacy literature; Tyler (1988, 2017); Jackson (2018); Creutzfeldt & Bradford (2016) |  |  |  |  |  |
| select_one m9_q12 | M9_Q12 | Omu nteekateka yaawe, abantu b'omukyaaro kyaawe nibateekateeka ngu kooti z'ebyaro zeine oburinganiza omu kushoboorora entongane zitari zimwe na zimwe? | This is respondent’s perception of community view, not the respondent’s own evaluation. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Procedural justice and legitimacy; Tyler (2017); Jackson (2018); Cooper-Knock & Macdonald (2020) |  |  |  |  |  |
| select_one m9_q14 | M9_Q14 | Omu kuteekateeka kwawe, abantu b'omukyaaro kyaawe ni bejumbira okureeta emishango emikye omu kooti ya LC omumwanya goku gitwaara aha police nainga omu kooti za heiguru? | This captures perceived forum choice and local legitimacy. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Forum choice and informal justice literature; Krakowski & Kursani (2024); Cooper-Knock & Macdonald (2020) |  |  |  |  |  |
| select_one m9_q15 | M9_Q15 | Omu kuteekateeka kwawe, abantu nibakira kuhingura bata akakiiko k'eby'obutegyeki bakaza omu pooriisi nari omu kooti omu mwanya gw'okugyenda omu kooti z'ebyaro? | Bypass means going directly to police/court without first approaching the LCC. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Forum choice; lower court engagement literature; Macdonald et al. (2022); Krakowski & Kursani (2024) |  |  |  |  |  |
| select_multiple m9_q16 | M9_Q16 | Ni nshonga ki enkuru ahabw'enki abantu abamwe barikubaasa kuhingura aho okukoresa kooti y ekyaaro bakaza omu pooriisi nainga omu kooti omu mwanya gw'okukoresa kooti y ekyaaro? Select up to three. | Ask neutrally. Do not imply that bypassing is always wrong. |  |  | count-selected(.) <= 3 | Select up to three options. |  |  |  |  |  |  |  |  |  |  |  | Forum-choice literature; Cooper-Knock & Macdonald (2020); Macdonald et al. (2022); Krakowski & Kursani (2024) |  |  |  |  |  |
| select_one m9_q17 | M9_Q17 | Omu kuteekateeka kwawe, okumanyangana kwa'bantu, okushoroora, ebiconco, esente, nainga okugyemeserezibwa nibibaasa kureeta ho akaabi aha obwenganiza aha kukoora aha mishango omu kooti ye'kyaaro? | Ask neutrally and do not ask for names or examples. This is a perceived corruption/favoritism risk item. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Procedural justice: neutrality/honesty; Jackson (2018); Macdonald et al. (2022) |  |  |  |  |  |
| select_one m9_q18 | M9_Q18 | Oine obukakafu bukwingana ki ngu kooti y'ekyaaro eiine obwesigye bw'abantu okushara emishango na n'okwohereza emishango emihango omu kooti za heiguru omubwenganiza? | This links legitimacy with referral decisions. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Referral explanation and legitimacy; Tyler (1988); CDFU training content |  |  |  |  |  |
| select_one m9_q19 | M9_Q19 | Okutwariza hamwe, noyekakasa ota ngu kooti yekyaaro neshaara emishango muburingaaniza na nomuringo oguri kugihereza ekitiinisa? | Self-assessed fairness capacity. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Procedural justice and training evaluation logic |  |  |  |  |  |
| text | M9_Q20 | Enumerator notes on procedural fairness and perceived local legitimacy | Record relevant context: respondent seemed uncomfortable, another person influenced the answer, respondent mentioned trust/corruption concerns, or answers contradicted earlier modules. Do not record names or case details. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Fieldwork data quality protocol |  |  |  |  |  |
| end group | end_m9_group |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| begin group | m10_group | Module 10. Gender, child protection, and serious-case safeguards |  |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| note | M10_Q00 | Hati ninza kubuuza ebibuuzo ebirikukwata aha mishango erikukwata aha bakazi, abaana, abatarikwebaasa, hamwe n'embeera ezindi ezitarikwetegyerezibwa gye. Ebibuuzo ebi nibikwata aha nkora y'okukora emirimo kandi tibirikukwata aha muntu weena nari omushango gwona. | Read aloud. Do not ask for examples or details of real sensitive cases. If respondent discloses an active serious case, follow the approved safeguarding protocol. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Safeguarding framework; CDFU training content; Rockowitz et al. (2024); Albezreh et al. (2022); Mennen (2010) |  |  |  |  |  |
| select_one m10_q07 | M10_Q07 | Omu kuteekateeka kwawe, emishango erimu abaana, abahonokireho obutabanguko, abaine oburema, nari abandi abatarikwebaasa, neeyetenga okukorwaho omu muringo gw'omutaano omu kooti ya LC? | If needed, explain “special handling” as additional care, confidentiality, safety, referral, or support. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Safeguarding and inclusion framework; Rockowitz et al. (2024); Mennen (2010) |  |  |  |  |  |
| select_multiple m10_q08 | M10_Q08 | Ni bujanjabi ki obw'omutaano oburikubaasa kwetengwa ahabw'emishango egi? Toorana ebyo byona ebirikukora. | Do not ask for examples. |  |  |  |  | and ${M10_Q07} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | Safeguarding framework; survivor-centered and child-sensitive response |  |  |  |  |  |
| select_one m10_v01 | M10_V01 | Enumerator verification: In the records seen today, is there evidence that sensitive or serious cases are marked as referred or directed to another authority when applicable? | Do not copy case details. Only assess whether serious/sensitive cases, if visible, show referral or direction. |  | quick |  |  | and ${M0_Q20} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU maturity tool; safeguarding record audit |  |  |  |  |  |
| select_one m10_v02 | M10_V02 | Enumerator verification: Based on the records seen today, do sensitive case records appear to be stored or written in a way that protects confidentiality? | Do not look for more details than necessary. If no sensitive records are visible, choose option 4. |  | quick |  |  | and ${M0_Q20} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | Data protection and safeguarding protocol |  |  |  |  |  |
| text | M10_Q15 | Enumerator notes on gender, child protection, and serious-case safeguards | Record relevant observations only at a general level. Do not record names, identifying details, allegations, or sensitive case facts. If any disclosure requires action, follow safeguarding protocol and document only through the approved safeguarding channel. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Fieldwork data quality and safeguarding protocol |  |  |  |  |  |
| end group | end_m10_group |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| begin group | m11_group | Module 11. Perceptions toward incarcerated and formerly incarcerated persons; reintegration norms |  |  |  |  |  | ${consent} = 1 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| note | M11_Q00 | Hati ninza kubuuza ebibuuzo ebirikukwata aha bantu abarikuruga omu bihome nari omu bihome bakagaruka omu byanga byabo. Ebibuuzo ebi nibikwata aha miteekateekyere y'abantu boona hamwe n'obuhwezi bw'abantu b'omubyanga. | Read aloud. Do not ask for names or details of specific formerly incarcerated persons. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | CDFU training content; Legatum reintegration results framework; restorative justice literature |  |  |  |  |  |
| select_one m11_q02 | M11_Q02 | Ni kikuru kita abebembezi b'ebyanga, otwariiremu n'abebembezi ba LC, okushagika okugaruka omu byaro kw'abantu abarikuruga omu bihome? | Measures perceived LC/community responsibility. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; Legatum reintegration results framework |  |  |  |  |  |
| select_one m11_q03 | M11_Q03 | Iwe nka chairpersons wa LC egi, nohangira ekyo muntu owaabaire ari omu kihome okugaruka omu kyaaro eki omubusingye? | This is about appropriate support within the LC/LCC role, not personal financial support. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; reintegration norms |  |  |  |  |  |
| select_one m11_q04 | M11_Q04 | Naba ninkushaba ngu ongambire waba noyikiriza ninga ori kuhakanisa ekihandiiko eki: Abantu abarikurekurwa kuruga omu bihome bashemereire kuheebwa omugisha gw'okugaruka kwejumba omu by'obuhangwa? | Attitude item. Keep wording neutral and read exactly. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Reintegration norms; restorative justice literature |  |  |  |  |  |
| select_one m11_q05 | M11_Q05 | Naba ninkushaba ngu ongambire waba noyikiriza ninga ori kuhakanisa ekihandiiko eki: Abantu abarikurekurwa kuruga omu bihome bashemereire kwetantarwa abantu b'omukyanga? | This is a stigma/exclusion item. Reverse-code in analysis. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; stigma/reintegration norms |  |  |  |  |  |
| select_one m11_q06 | M11_Q06 | Naba ninkushaba ngu ongambire waba noyikiriza ninga ori kuhakanisa ekihandiiko eki: Abantu abarikukiira obwingi abarikurekurwa kuruga omu bihome nibaza kugaruka bakore ebihagaro ebindi? | This measures perceived reoffending risk/stigma. Reverse-code depending on index direction. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Legatum reincarceration prevention framework; reintegration/stigma literature |  |  |  |  |  |
| select_one m11_q07 | M11_Q07 | Naba ninkushaba ngu ongambire waba noyikiriza ninga ori kuhakanisa ekihandiiko eki: Abantu baine obuvunanizibwa kuhwera abo abarikuruga omu bihome okwetantara okugaruka okugaruka kukora ebihagaro." | Measures belief in community role in prevention and reintegration. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; Legatum reintegration results framework |  |  |  |  |  |
| select_one m11_q08 | M11_Q08 | Noye kaakaza ota okushara omushango gurimu owabaire ari omusibe hamwe n'omuntu ondiijo wa burijo omu LC yaawe? | Emphasize “if it is within the LCC’s mandate.” Serious cases still require referral. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; ADR/reintegration interface; restorative justice literature |  |  |  |  |  |
| select_one m11_q09 | M11_Q09 | Noobaasa kuhwera omuntu owaabaire ari omu kihome kuhikaana n'abantu abandi, obuheereza nka PDM, nari abebembezi b'ekyaro? | This does not require respondent to provide money or personal resources. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; Legatum reintegration results framework |  |  |  |  |  |
| select_multiple m11_q10 | M11_Q10 | Ni buhwezi ki oburikubaasa kuhwera omuntu orikuruga omu kihome kugaruka omu bantu? Toorana oburikukora. | Do not suggest that the LC itself must provide all support. |  |  | (not(selected(., '9') and count-selected(.) > 1)) | Do not combine 'None' or 'Do not know' with other options. |  |  | yes | This question is required. |  |  |  |  |  |  |  | Legatum reintegration conditions; CDFU training content |  |  |  |  |  |
| select_one m11_q11 | M11_Q11 | Omu kureeba kwawe, okujumwa nari okutwarizibwa kubi omu bantu abarikugaruka omu byanga byabo bwanyima y'okuruga omu bihome nari okukomwa, nikukira kubaho? | Ask about general perception, not a specific person. |  |  |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | Reintegration norms; stigma measurement; Legatum results framework |  |  |  |  |  |
| select_multiple m11_q12 | M11_Q12 | Ni nshonga ki enkuru ezirikubaasa kureetera abantu kutenda kwikiriza nari kushagika omuntu owaabaire ari omu kihome? Toorana enshonga ishatu. | Ask neutrally. Do not ask for names or examples. |  |  | count-selected(.) <= 3 | Select up to three options. |  |  |  |  |  |  |  |  |  |  |  | Reintegration barriers; Legatum reintegration framework |  |  |  |  |  |
| select_one m11_q13 | M11_Q13 | Omu myezi mukaaga ehwaire, akakiiko k'ebyaro/akakiiko k'ebyaro kashoboroire enshonga zoona, obunkenke, nari okwerarikirira kw'abantu abarikugaruka omu byaro kuruga omu bihome? | Do not ask for names or case details. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; reintegration-related case handling |  |  |  |  |  |
| select_multiple m11_q14 | M11_Q14 | Ni shonga ki eyakozirweho akakiiko k'ebyaro? Toorana zoona ezirikukora. | Do not record names, locations, or identifying case details. |  |  |  |  | and ${M11_Q13} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | Reintegration-related case typology; CDFU training content |  |  |  |  |  |
| select_one m11_q15 | M11_Q15 | Abakuru b'ekyaro bakakora ki aha nshonga ezirikukwata aha muntu owaabaire ari omu kihome? | Ask for the main response only. Do not collect case details. |  |  |  |  | and ${M11_Q13} = 1 |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; ADR/reintegration mechanism |  |  |  |  |  |
| select_one m11_q16 | M11_Q16 | Oine obwesigye ki ngu akakiiko k'ebyaro nikabaasa kuhwera omu kukyendeeza obunkenke omu bantu abarikukwata aha bantu abarikuba bararekwirwe kuruga omu bihome, enshonga egi yaaba eri omu nshonga zaabo? | Emphasize “within its role and mandate.” |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; reintegration/community conflict mechanism |  |  |  |  |  |
| select_one m11_q17 | M11_Q17 | Oine obwesigye ki ngu nomanya ahu orikuza kutwara omuntu owabaire ari omu kihome orikwenda obuhwezi oburengire obu abakuru b'ebyaro barikubaasa kuheereza? | Support may include psychosocial, livelihood, legal, or social service support. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; referral/support pathway knowledge |  |  |  |  |  |
| select_one m11_q18 | M11_Q18 | Omu kuteekateeka kwawe, obuhwezi bw'ababaireho abasibe bushemereire kuba buri omu mirimo y'oburingaaniza n'obwebembezi bw'ekyaro? | This captures normative alignment with the intervention content. |  | quick |  |  |  |  | yes | This question is required. |  |  |  |  |  |  |  | CDFU training content; Legatum reintegration results framework |  |  |  |  |  |
| select_multiple m11_q19 | M11_Q19 | Abakuru b'ebyaro bashemereire kukora ki kuhwera abantu kugaruka omu byaro byabo? Tooranaho bishatu. | Ask for broad roles, not commitments to provide services personally. |  |  | count-selected(.) <= 3 | Select up to three options. | and ${M11_Q18} = 1 |  |  |  |  |  |  |  |  |  |  | CDFU training content; reintegration/community leadership role |  |  |  |  |  |
| text | M11_Q20 | Enumerator notes on perceptions toward incarcerated and formerly incarcerated persons | Record relevant general observations only. Do not record names, identifying details, or allegations involving specific persons. If a current serious case is disclosed, follow safeguarding protocol. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | Fieldwork data quality and safeguarding protocol |  |  |  |  |  |
...
| yesno | 0 | No |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Enum | 3 | Ashabe Gina |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Enum | 4 | Atukwase Shallon |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Enum | 5 | Najib Kizito |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Enum | 6 | Natuhwera Sylivia |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Enum | 7 | Kagoro Meliza |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Enum | 8 | Nayebare Christine |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Enum | 9 | Akankwasa Ronald |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Enum | 10 | Natukunda Britah |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Enum | 1 | Barry |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Enum | 2 | Harriet |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Enum | 11 | Ian |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Phase 1 Baseline_Runyankore | phase_1_baseline_Runyankore | 2608210518 |  |  | english |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
## Sheet: help-survey
